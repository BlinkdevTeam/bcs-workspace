...
// ── Mock data ─────────────────────────────────────────────────────────────────
const MOCK_TASKS = [
  { id: 1,  name: "Set up Redux store",                priority: "high",   status: "progress", project: "BCS Workspace", due: "2026-03-13", person: "KM", done: false, parent_id: null, description: "" },
  { id: 2,  name: "Configure Axios interceptors",      priority: "high",   status: "progress", project: "BCS Workspace", due: "2026-03-13", person: "KM", done: false, parent_id: null, description: "" },
  { id: 3,  name: "Build ProtectedRoute component",    priority: "medium", status: "todo",     project: "BCS Workspace", due: "2026-03-14", person: "KM", done: false, parent_id: null, description: "" },
  { id: 4,  name: "Health check endpoint + CORS",      priority: "medium", status: "review",   project: "BCS Workspace", due: "2026-03-13", person: "JD", done: false, parent_id: null, description: "" },
  { id: 5,  name: "Create tasks-backend boilerplate",  priority: "low",    status: "done",     project: "BCS Workspace", due: "2026-03-10", person: "KM", done: true,  parent_id: null, description: "" },
  { id: 11, name: "Install redux toolkit",             priority: "high",   status: "done",     project: "BCS Workspace", due: "2026-03-13", person: "KM", done: true,  parent_id: 1,    description: "" },
  { id: 12, name: "Create authSlice",                  priority: "medium", status: "progress", project: "BCS Workspace", due: "2026-03-13", person: "KM", done: false, parent_id: 1,    description: "" },
  { id: 13, name: "Create uiSlice",                    priority: "low",    status: "todo",     project: "BCS Workspace", due: "2026-03-14", person: "KM", done: false, parent_id: 1,    description: "" },
  { id: 14, name: "Set baseURL and withCredentials",   priority: "high",   status: "done",     project: "BCS Workspace", due: "2026-03-13", person: "KM", done: true,  parent_id: 2,    description: "" },
  { id: 15, name: "Add request interceptor",           priority: "high",   status: "progress", project: "BCS Workspace", due: "2026-03-13", person: "KM", done: false, parent_id: 2,    description: "" },
  { id: 16, name: "Add silent refresh on 401",         priority: "high",   status: "todo",     project: "BCS Workspace", due: "2026-03-13", person: "JD", done: false, parent_id: 2,    description: "" },
  { id: 6,  name: "Design HRIS employee profile page", priority: "high",   status: "todo",     project: "HRIS Redesign", due: "2026-03-10", person: "AL", done: false, parent_id: null, description: "" },
  { id: 7,  name: "Build department management UI",    priority: "medium", status: "progress", project: "HRIS Redesign", due: "2026-03-14", person: "JD", done: false, parent_id: null, description: "" },
  { id: 8,  name: "Set up React Router for HRIS",      priority: "low",    status: "done",     project: "HRIS Redesign", due: "2026-03-09", person: "AL", done: true,  parent_id: null, description: "" },
  { id: 17, name: "Design personal info tab",          priority: "high",   status: "todo",     project: "HRIS Redesign", due: "2026-03-10", person: "AL", done: false, parent_id: 6,    description: "" },
  { id: 18, name: "Design job info tab",               priority: "medium", status: "todo",     project: "HRIS Redesign", due: "2026-03-10", person: "AL", done: false, parent_id: 6,    description: "" },
  { id: 9,  name: "Design onboarding screens",         priority: "high",   status: "todo",     project: "Mobile App",    due: "2026-03-11", person: "KM", done: false, parent_id: null, description: "" },
  { id: 10, name: "API integration for mobile auth",   priority: "medium", status: "progress", project: "Mobile App",    due: "2026-03-13", person: "JD", done: false, parent_id: null, description: "" },
];
...
export default function MyTasks() {
  ...
  const [selectedTask, setSelectedTask]   = useState(null); // task open in panel
  ...
  const addSubtask = (parentId) => {
    ...
    const newTask = {
      ...
      project: parent.project, due: parent.due, person: parent.person,
          ...
          <table style={s.table}>
            <thead>
              <tr>
                ...
                <th style={{ ...s.th, width: 110 }}>Person</th>
    ...
    <>
      ...
      {!isSubtask && isExpanded && (
        <>
          {subtasks.map((sub) => (
            <TaskRow
              key={sub.id} task={sub} subtasks={[]} isExpanded={false}
...
const s = {
  // Layout
  root:            { background: "#141414", height: "100%", minHeight: "100vh", display: "flex", flexDirection: "row", overflow: "hidden" },
